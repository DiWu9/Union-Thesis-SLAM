...
def ten_frame_test():
    ...
    camera_pose = read_trajectory("../dataset_stonewall/stonewall_trajectory.log")
    ...
    grid_fusion.meshwrite("mesh_hash_demo4.ply", verts, faces, norms, colors)

    # Get point cloud from voxel volume and save to disk (can be viewed with Meshlab)
    point_cloud = hash_table.get_point_cloud()
    grid_fusion.pcwrite("pc_hash_demo4.ply", point_cloud)
